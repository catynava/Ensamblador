...
public class BaseParpadeoSalidaEspecificaTemplates implements AsmTemplate{
    @Override
    ...
    public String getFileName() {
        return "parpadeo_salida_especifica_base";
    }

    @Override
    public String getContent() {
        return "; --- CODIGO BASE + PARPADEO (CON SALIDA ESPECIFICA) ---\n"
            + "\n"
            + "\n"
            + ".MODEL SMALL\n"
            + ".STACK 100h\n"
